var server = '104.175.236.1';
//var BOSH_SERVICE = 'http://104.175.236.1:7070/http-bind/';
var BOSH_SERVICE = 'http://127.0.0.1:7070/http-bind/'
// to use BOSH_SERVICE at 104.175.236.1, SSL is req'd
// room name should have a . after
var ROOM = '' + server;
// room service name should have a . after
var ROOM_SERVICE = '.' + server;
var connection = null;
...
//usage: <username> @ domain.com
//user1@104.175.236.1
  $('#jid').get(0).value = "user@domain.com";
  $('#pass').get(0).value = "";
